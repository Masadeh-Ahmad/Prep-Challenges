...
const replaceWords = (str) => {
    ...
    if(arr.indexOf("I")!=-1) arr.splice(arr.indexOf("I"),1,"We")

    if(arr.indexOf("am")!=-1) arr.splice(arr.indexOf("am"),1,"are")
    
    if(arr.indexOf("was")!=-1) arr.splice(arr.indexOf("was"),1,"were")
...
const arrToStr = (arr) => {
    ...
    for(let i=0;i<arr.length;i++){
        if((i+1)%5==0){
            if(i!=arr.length-1) r=r.concat(arr[i]+", ")
            else r=r.concat(arr[i]+",")
        } 
        else {
            if(i!=arr.length-1)r=r.concat(arr[i]+" ")
            else r=r.concat(arr[i])
