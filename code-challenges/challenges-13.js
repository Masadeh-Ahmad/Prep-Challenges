...
const objectCounter = (obj) => {
  return obj.reduce((count, currentValue) => (count += 1), 0);
};
// -------------------------------------------------------------------------------------------------------
...
const statistics = (obj) => {
  return obj.reduce((newobj, obj) => {newobj[obj.votes_To] ? (newobj[obj.votes_To] += 1) : (newobj[obj.votes_To] = 1);return newobj;}, {});
};
// -------------------------------------------------------------------------------------------------------
